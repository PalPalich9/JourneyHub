...
6. Запустите файл **start.bat** (см. Рисунок 1)
...
5. Нажмите на кнопку 'Искать' (см. Рисунок 2)
...
2. Введите в поле **'ММ'**, правее значка часов минуты отправления. Будут искаться только маршруты позже отправленного времени
...
- **!!! Важно !!!**
  ...
  - Волгоград, Воронеж, Екатеринбург, Ижевск, Казань, Краснодар, Красноярск, Москва, Нижний Новгород, Новосибирск, Омск, Пермь, Растов-На-Дону, Самара, Санкт-Петербург, Саратов, Тольятти, Тюмень, Уфа, Челябинск, Якутс
  - обратите внимание, что рейс 1881433 - это прямой рейс между Москвой и Воронежем, состоящий из нескольих маршрутов!
...
1. Введите в поле **'Откуда'** город отправления (обязательно кириллицей). Например: Москва
2. Введите в поле **'Куда'** город прибытия (обязательно кириллицей). Например: Воронеж
3. Нажмите на кнопку **'Искать'** (см. Рисунок 3)
...
5. Для обновления списка нажмите на кнопку **'Обновить'** (см. Рисунок 1 пункт)
![image](https://github.com/user-attachments/assets/e37d8e70-8aea-42f9-b578-a5dedcd261c8)
*рис. Обновление забронированных билетов*
...
![image](https://github.com/user-attachments/assets/80993195-ce75-47d6-8eb8-bba433e2a5a1)
*рис. Отмена билета*
